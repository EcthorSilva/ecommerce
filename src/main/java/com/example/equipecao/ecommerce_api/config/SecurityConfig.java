    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/login", "/signup","/backoffice-login", "/catalog", "/faq", "/cart", "/product", "/401", "/checkout", "/payment/**","/api/produtos", "/api/pedidos", "/api/produtos/**", "/api/produtos/search", "/api/produtos/distribuidor/**", "/api/usuarios", "/api/clientes","/static/vendor/**", "/static/assets/**", "/h2-console").permitAll() // Permitir acesso público à página de login, arquivos estáticos e etc
