    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/login", "/signup","/backoffice-login", "/catalog", "/faq", "/cart", "/product","/api/produtos", "/api/produtos/**", "/api/produtos/search", "/api/produtos/distribuidor/**", "/api/usuarios", "/static/vendor/**").permitAll() // Permitir acesso público à página de login, arquivos estáticos e etc
